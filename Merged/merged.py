...
def alarm1():
    mixer.init()
    mixer.music.load("/Users/vemundwoien/Documents/Forste.mp3")
    mixer.music.play()

def alarm2():
    mixer.init()
    mixer.music.load("/Users/vemundwoien/Documents/Fare.mp3")
    mixer.music.play()

def alarm3():
    mixer.init()
    mixer.music.load("/Users/vemundwoien/Documents/GENALARM.mp3")
    mixer.music.play()
